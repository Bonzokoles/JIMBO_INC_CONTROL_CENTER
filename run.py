...
if __name__ == '__main__':
    print("Starting JIMBO INC Control Center...")
    # Define the URL
    app_url = 'http://127.0.0.1:6025' # JIMBO INC Control Center port
    ...
    try:
        app.run(debug=True, port=6025, host='127.0.0.1')
    except Exception as e:
        print(f"Error running Flask server: {e}")
        print("Please check if port 6025 is already in use.")
