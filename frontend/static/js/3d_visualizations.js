...
class DataVisualizer {
  ...
  createScene() {
    ...
    // Usunięte tło sceny dla przezroczystości za widgetami
  ...
  createLights() {
    // Ambient light for overall illumination - zmniejszona intensywność
    const ambientLight = new THREE.AmbientLight(0x202020, 0.15);
    this.scene.add(ambientLight);

    // Main directional light - bardziej neutralne światło
    ...
    // Point light for dramatic effect - zmniejszona intensywność
    const pointLight = new THREE.PointLight(0x0088ff, 0.4, 30);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 3D Visualization initialized successfully
});
